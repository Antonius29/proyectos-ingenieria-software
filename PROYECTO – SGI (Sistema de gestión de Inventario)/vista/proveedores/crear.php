...
?>
    ...
    <div class="container-small">
        ...
        <div class="card">
            <h1><i class="bi bi-truck"></i> Agregar Nuevo Proveedor</h1>
            <p style="color: var(--color-gray-medium); margin-bottom: 30px;">Complete el formulario para registrar un nuevo proveedor en el sistema</p>
            ...
            <form action="index.php?modulo=proveedores&accion=guardar" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" required placeholder="Nombre del contacto principal" value="<?php echo htmlspecialchars($datos['nombre'] ?? ''); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="notas" name="notas" placeholder="Informacion adicional sobre el proveedor..."><?php echo htmlspecialchars($datos['notas'] ?? ''); ?></textarea>
                </div>

                <div class="button-group">
                    <a href="index.php?modulo=proveedores&accion=lista" class="btn btn-secondary"><i class="bi bi-x-circle"></i> Cancelar</a>
                    <button type="submit" class="btn btn-primary"><i class="bi bi-check-circle"></i> Guardar Proveedor</button>
                </div>
            </form>
        </div>
    </div>
